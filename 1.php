<html lang="zxx"><head>
	<title>Aplikasi Arisan | Adezulfi</title>
	<!-- Meta tag Keywords -->
				...
				<div class="container">
					...
					<div class="row border-bottom py-lg-4 py-3">
						<div class="col-xl-7 col-lg-6 header_agileits_left">
							<ul>
								<li class="mr-3">
									<i class="fas fa-phone mr-2"></i> +(62)878 221 918 811</li>
								<li>
									<i class="fas fa-envelope mr-2"></i>
									<a href="mailto:info@example.com">infoarisan@egmail.com</a>
								</li>
							</ul>
						</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br><center><p>Developed by <a href='adezulfi.com' title='adezulfi.com' target='_blank'>Ade Muhammad Zulfikri</a></p></center>
