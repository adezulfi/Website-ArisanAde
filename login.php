    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="index.php">Social Gathering</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="index.php">Call Now</a></li>
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body my-5 pt-4">
                ...
                <br><center><p>Repost by <a href='adezulfi.com/' title='adezulfi.com' target='_blank'>Ade Muhammad Zulfikri</a></p></center>
