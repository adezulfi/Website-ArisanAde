...
<head>
	<title>Aplikasi Arisan | Home : adezulfi</title>
	<!-- Meta tag Keywords -->
...
<body>
				...
				<div class="container">
					...
					<div class="row border-bottom py-lg-4 py-3">
						<div class="col-xl-7 col-lg-6 header_agileits_left">
							<ul>
								<li class="mr-3">
									<i class="fas fa-phone mr-2"></i> +(062) 878 8275 3411</li>
								<li>
									<i class="fas fa-envelope mr-2"></i>
									<a href="mailto:info@arisan.com">arisanadezulfi@gmail.com</a>
								</li>
							</ul>
						</div>
		...
		<div class="banner-text-agile">
			<div class="container">
				<div class="banner-w3lstexts text-white text-center">
					...
					<br><center><p style="color: white;">Design by <a style="color: white;" href='https://adezulfi.com/' title='Ade Muhammad Zulfikri' target='_blank'>Ade Muhammad Zulfikri</a></p></center>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="login px-4 mx-auto mw-100">
						...
						<br><center><p>Developed by <a href='https://adezulfi.com/' title='adezulfi.com' target='_blank'>Ade Muhammad Zulfikri</a></p></center>
				...
				<div class="modal-body">
					<div class="login px-4 mx-auto mw-100">
						...
						<form method="POST" name="sentMessage" role="form">
							...
							<p class="text-center pb-4">
								<a href="#">Mendaftar dan Saya setuju ketentuannya</a>
							</p>
						</form>
					</div>
				</div>
			...
			<div class="address row mb-4">
				<div class="col-lg-4 address-grid">
					<div class="row address-info">
						...
						<div class="col-md-9 address-right text-left">
							...
							<p>
								<a href="mailto:example@email.com"> arisanadezulfi@gmail.com</a>
							</p>
				...
				<div class="col-lg-4 address-grid my-lg-0 my-4">
					<div class="row address-info">
						...
						<div class="col-md-9 address-right text-left">
							<h6 class="ad-info text-uppercase mb-2">Hubungi saya</h6>
							<p>0878 8275 3411</p>
	...
	<div class="copy_right py-4 text-center">
		<p class="text-white">© 2023 Social Gathering . All rights reserved | Design by
			<a href="adezulfi">Ade Muhammad Zulfikri</a>
		</p>
	</div>
	<!-- //copyright -->
